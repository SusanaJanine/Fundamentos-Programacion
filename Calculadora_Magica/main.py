...
# Opcion 1 esta definida para realizar operaciones de suma.
        elif opcion == 1:
...
# Opcion 2 permite realizar operaciones de resta.
        elif opcion == 2:
...
# Opcion 3 es la opcion que permite realizar multiplicaciones.
        elif opcion == 3:
...
# Opcion 4 permite realizar divisiones, utilizando while primero para validar sus numeros y evitar realizar operaciones con 0.            
        elif opcion == 4:
...
# Opcion 5 su funcion es calcular la raiz cuadrada de un numero siempre y cuando el numero no sea negativo.
        elif opcion == 5:
            print("Has elegido el camino de la raiz cuadrada")
            while True:
                try:
                    n1 = float(input("Favor de ingresar el numero para calcular su raiz cuadrada: "))
                    if n1 < 0:
...
# Opcion 6 permite calcular la potencia de un numero, utilizando la funcion pow que fue importada desde math.
        elif opcion == 6:
...
# Opcion 7 permite calcular el logaritmo de un numero, utilizando la funcion log importada desde math.
        elif opcion == 7:
            print("Has elegido el camino del logaritmo")
            n1 = float(input("Favor de ingresar el numero para calcular su logaritmo: "))
...
# Opcion 8 utiliza la funcion exp importada desde math, dicha funcion permite calcular el exponencial de un numero.
        elif opcion == 8:
            print("Has elegido el camino de la exponencial")
            n1 = float(input("Favor de ingresar el numero para calcular su exponencial: "))
...
# Opcion 9 realiza una conversion de km a millas
        elif opcion == 9:
...
# Opcion 10 su funcion es convertir fahrenheit a celsius
        elif opcion == 10:
...
# Opcion 11 realiza la conversion de Libras a Kilogramos.
        elif opcion == 11:
...
# Opcion 12 convierte metros a kilometros.
        elif opcion == 12:
...
# Opcion 13 realiza conversiones de centimeros a metros.
        elif opcion == 13:
...
# Opcion 14 su funcion es realizar conversiones de horas a minutos.
        elif opcion == 14:
...
# Para las opciones 16, 17 y 18 se solicitan al usuario un numero pero primero se convierte ese numero a radianes. Porque las funciones trigonometricas en python trabajan con radianes, por lo que es necesario convertir el numero ingresado a radianes.

# Opcion 16 permite calcular la tangente de un numero, mediante el uso de radiantes, el resultado puede no ser un numero exacto pero si cercano.  
        elif opcion == 16:
...
# Opcion 17 permite calcular el seno de un numero, mediante el uso de radiantes.
        elif opcion == 17:
...
# Opcion 18 permite calcular el coseno de un numero, mediante el uso de radiantes
        elif opcion == 18:
...
# Opcion 19 creada para calcular el area de un rectangulo
        elif opcion == 19:
...
# Opcion 20 permite calcular el área de un circulo mediante la constante pi importada desde math.
        elif opcion == 20:
...
# Opcion 21 permite realizar dos operaciones al mismo tiempo, primero realiza la suma de dos numeros y posteriormente calcula la raiz cuadrada del resultado de la suma.
        elif opcion == 21:
...
# Opcion 22 determina el area y el precio total de un terreno, realiza dos multiplicaciones.
        elif opcion == 22:
...
# Opcion 23 creada para obtener el historial de las operaciones y funciones utilizadas.
        elif opcion == 23:
            print("--- Historial ---")
            if historial:
